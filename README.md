...
- Analyzed 1.06M+ online retail transactions using Python and PostgreSQL, producing 793K validated records and customer-level RFM features through SQL CTEs and window functions.
- Developed a leakage-aware temporal churn model with 0.737 test ROC-AUC and 0.750 recall, then visualized customer segments, risk scores, and 90-day value estimates in Tableau.
